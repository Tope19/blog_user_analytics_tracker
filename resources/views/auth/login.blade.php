...
<head>
     ...
     <link rel="stylesheet" href="{{ $web_source }}/assets/sass/main.css">
     <link rel="stylesheet" href="{{ $web_source }}/assets/css/hover.css">
     <link rel="stylesheet" href="{{ $web_source }}/assets/fontawesome/css/all.css">
     <!-- Font family -->
     <link
    ...
    <link href="https://fonts.googleapis.com/css?family=Open+Sans&amp;display=swap" rel="stylesheet">
     <!-- link for boostrap -->
     <link rel="stylesheet" href="{{ $web_source }}/assets/sass/vendours/boostrap/css/bootstrap.css">



     <!-- Link for Flickity -->
     <link rel="stylesheet" href="{{ $web_source }}/assets/flickity/flickity.css" media="screen">
     <script src="https://unpkg.com/flickity@2/dist/flickity.pkgd.min.js"></script>
     <!-- Script for flickity -->
     <script src="{{ $web_source }}/assets/flickity/flickity.pkgd.min.js" charset="utf-8"></script>
     <title>Login</title>
 </head>
        ...
        <div class="form__box form__login--box form__box--2">
            <div class="row">
                <div class="col-md-6 form__box--item">
                    <h1><a href="{{ route('homepage') }}"><i class="fal fa-home"></i>Home</h1></a>
                    <img src="{{ $web_source }}/assets/images/login-bg3.png" alt="Sign up" class="form__login--img">
                </div>
                <div class="col-md-6 form__box--item form__box--item--1">
                    <div class="form__logo">

                        <p>Become a member of the <b style="color: #e41111">Mini-</b> Blog!</p>
                    </div>
                     <br>
                    ...
                    @csrf
                        ...
                        @endif
                        <p class="redirect"><font size="3px">Don't have an account? <a href="{{ route('register') }}">Sign up</a></p></font>
                        <br><br>
                    </form>
                </div>
            </div>
